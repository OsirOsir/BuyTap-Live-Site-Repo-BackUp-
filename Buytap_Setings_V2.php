...
// == CLOSE-TIME SYNC: server 'now' endpoint ==
add_action('rest_api_init', function () {
  register_rest_route('buytap/v1', '/now', [
    ...
    'callback' => function () {
      ...
      // Read & auto-reset the flag
      $force = (int) get_option('buytap_force_close', 0);
      if ($force) {
        update_option('buytap_force_close', 0); // reset once read
      }
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <table class="form-table">
				...
				<tr>
				  <th scope="row">Force Close Current Window</th>
				  <td>
					<label>
					  <input type="checkbox" name="buytap_force_close" value="1"
						<?php checked(get_option('buytap_force_close', 0), 1); ?>>
					  Immediately close the active trading form
					</label>
					<p class="description">Check and save to force close. Once triggered, it will reset itself back to off.</p>
				  </td>
				</tr>
            </table>
            <?php submit_button(); ?>
